 ...
 * mutators (mu=); a link without v is a v1 link = Downtown, no mutators. v=3: the double jump + web
 * zip (the ghost record says which ruleset it replays with: format 1 = without them).
 */
