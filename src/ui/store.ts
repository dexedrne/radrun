...
export const useUi = create<UiState>(() => ({
  ...
  screen: "boot",
  paused: false,
  round: { clock: 90, d: 0, panic: false, gassed: false, ring: "none", speed: 0, countdown: 3, fps: 0, holdR: 0, chain: 0, maxChain: 0, topSpeed: 0, falls: 0, elapsed: 0, wind: null, zip: 0 },
  results: null,
  feed: [],
  banner: null,
  bubble: null,
